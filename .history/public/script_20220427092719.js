...
async function getGameName(){
    ...
    if(data[number]== undefined){
        ...
        document.querySelector('#publisher').textContent = "Editores: "+data[number].publisher;
        document.querySelector('#developer').textContent = "Desarrollador: "+data[number].developer;
        document.querySelector('#platform').textContent = "Plataforma "data[number].platform;
        a.href = data[number].game_url;
        a.textContent = "Ir al juego";
        a.target="_blank";
